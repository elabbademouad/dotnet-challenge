...
namespace Cds.DroidManagement.Domain.Tests.Integration
{
    public class DroidHandlerTests
    {
        ...
        public async Task HandleCreateDroid_WithValidDroid_DroidCreatedSuccessfully()
        {
            ...
            // Act
            var droidCreated = await droidHandler.HandleAsync(createDroid);
        ...
        public async Task HandleUpdateDroid_WithValidName_DroidUpdatedSuccessfully()
        {
            ...
            // Act
            await droidHandler.HandleAsync(updateDroid);
        ...
        public async Task HandleDeleteDroid_WithNonExistantSerialNumber_ThrowsDroidNotFoundException()
        {
            ...
            _repoArmMock
                .Setup(repo => repo.DeleteAsync(It.IsAny<List<ArmId>>(), It.IsAny<object>()))
                .Returns(Task.FromResult(true));
            var action = DeleteArmListAction.CreateNew(new List<ArmId>(), _repoArmMock.Object.DeleteAsync);
            _repoMock
                .Setup(repo => repo.DeleteAsync(_serialNumber, action))
                .Returns(Task.FromResult(false));
        ...
        public async Task HandleCreateArm_WithValidDroidId_ArmCreatedSuccessfully()
        {
            ...
            // Act
            await droidHandler.HandleAsync(createArm);
